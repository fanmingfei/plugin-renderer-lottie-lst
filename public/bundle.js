...
(function (pixi_js) {
            ...
            ***************************************************************************** */
            ...
            /* Built-in method references that are verified to be native. */
            var DataView$2 = getNative$1(root$1, 'DataView');
            ...
            if ((DataView$2 && getTag$2(new DataView$2(new ArrayBuffer(1))) != dataViewTag$3) ||
            ...
            ***************************************************************************** */
            ...
            function getSpineData(name) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, resource.getResource(name)];
                            case 1:
                                res = _a.sent();
                                data = dataMap[name];
                                if (!data) {
            ...
            var SpineSystem = /** @class */ (function (_super) {
                ...
                SpineSystem.prototype.remove = function (changed) {
                    ...
                    if (changed.type === ObserverType.CHANGE) ;
                };
            ...
            resource.addResource([
                {
                    ...
                    src: {
                        ske: {
                            type: 'json',
                            url: 'https://pages.tmall.com/wow/eva/e232c072e2397d39dfd16bcc596e67c3_ske.json',
                        },
                        atlas: {
                            type: 'atlas',
                            url: 'https://pages.tmall.com/wow/eva/9a1af20287a9570f2e19c885250a9969.atlas',
                        },
                        image: {
                            type: 'png',
                            url: 'https://gw.alicdn.com/imgextra/i1/O1CN01HMzbK21J7LEeRIbQK_!!6000000000981-2-tps-1570-1570.png',
                        },
                    },
                },
            ]);
            var spine = new Spine({ resource: 'anim', animationName: 'chui' });
            go.addComponent(spine);
            spine.on('complete', function (e) {
